...
\input{Time Series Classification Algorithms/PF.tex}

\subsection{Phase Dependent intervals Algorithms}
\input{Time Series Classification Algorithms/Phase Dependent.tex}
\subsubsection{Time Series Forest}
\input{Time Series Classification Algorithms/TSF.tex}
